...
//collapsToolbar.setBackgroundDrawable();
        try {
            ...
            txtbdate.setText(CommonClass.changeDateFormate(objStudData.getString("student_birthdate"),4));
    ...
    public class getUserData extends AsyncTask<Void, Void, String> {
            ...
            try {
                ...
                if (jObj.has("responce") && !jObj.getBoolean("responce")) {
                    ...
                    if (jObj.has("data")) {
                        ...
                        Toast.makeText(ProfileActivity.this, responseString, Toast.LENGTH_SHORT).show();
                    }
                }
        ...
        protected void onPostExecute(final String success) {
            ...
            if (response) {
                ...
                setContentView(R.layout.include_error_msg);
                ((TextView) findViewById(R.id.tv_error_msg)).setText(getResources().getString(R.string.profile_information_not_updated));
