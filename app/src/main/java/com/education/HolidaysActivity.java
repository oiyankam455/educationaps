...
public class HolidaysActivity extends CommonAppCompatActivity {
    ...
    public class HolidayAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            try {
                Date a_date = CommonClass.convetStringToDate(String.valueOf(current_year) + "-" + String.valueOf(month) + "-" + String.valueOf(dates), 1);
                ...
                for (int i = 0; i < objAttendenceData.length(); i++) {
                    ...
                    Date b_date = CommonClass.convetStringToDate(obj.getString("holiday_date"), 1);
                ...
                if (a_date.equals(todayDate)) {
                    ...
                    day.setTextColor(getResources().getColor(R.color.color_3));
                }
