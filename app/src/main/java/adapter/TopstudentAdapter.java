...
public class TopstudentAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        try {
            ...
            txtrollno.setText(context.getResources().getString(R.string.roll_no) + jObj.getString("student_roll_no"));
            txtstandard.setText(context.getResources().getString(R.string.standard) + jObj.getString("standard_title"));
            ImageView top_image = (ImageView) convertView.findViewById(R.id.profile_image);
