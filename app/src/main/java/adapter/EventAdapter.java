...
public class EventAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        try {
            ...
            start_date.setText(context.getResources().getString(R.string.from) + CommonClass.changeDateFormate(jObj.getString("event_start"), 4));
            end_date.setText(context.getResources().getString(R.string.to) + CommonClass.changeDateFormate(jObj.getString("event_end"), 4));
