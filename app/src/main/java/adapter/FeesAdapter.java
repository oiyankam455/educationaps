...
public class FeesAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        try {
            ...
            txtDate.setText(CommonClass.changeDateFormate(jObj.getString("pay_date"), 4));

            TextView txtAmount = (TextView) convertView.findViewById(R.id.tv_fees_amount);
            txtAmount.setText(jObj.getString("fee_amount") + " " + ConstValue.CURRENCY);

            TextView txtpayAmount = (TextView) convertView.findViewById(R.id.tv_fees_pay_amount);
            txtpayAmount.setText(jObj.getString("pay_fee_amount") + " " + ConstValue.CURRENCY);
            ...
            txtLeftAmount.setText("" + total_left + " " + ConstValue.CURRENCY);

            TextView txtpayAmountLast = (TextView) convertView.findViewById(R.id.tv_fees_pay_amount_last);
            txtpayAmountLast.setText(jObj.getString("last_paid_amount") + " " + ConstValue.CURRENCY);
