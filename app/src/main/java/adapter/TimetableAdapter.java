...
public class TimetableAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        try {
            ...
            txtsubject.setText(context.getResources().getString(R.string.subject) + jObj.getString("subject"));
            txtteacher.setText(context.getResources().getString(R.string.teacher) + jObj.getString("teacher_name"));
